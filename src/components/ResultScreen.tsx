        ...
        <div className="text-center">
          ...
          <div className="mt-2 space-y-0.5 text-sm text-cream-muted sm:mt-3">
            <p>
              ...
              {score.credits_over_budget > 0 && score.credit_budget > 0 && (
                <span className="text-crimson">
                  {" "}
                  ({score.credits_over_budget} over {score.credit_budget})
                </span>
              )}
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {score.breakdown.map((row) => (
                ...
                >
                  <td className="px-3 py-2 font-[family-name:var(--font-mono)] text-xs text-cream-muted">
                    {row.slot}
                  </td>
